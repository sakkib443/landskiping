...
<header x-data="{ open: false, scrolled: false }" @scroll.window="scrolled = (window.scrollY > 8)">
    ...
    {{-- Main nav --}}
    <div class="sticky top-0 z-50 border-b border-sand-200 bg-white/95 backdrop-blur transition-shadow duration-300" :class="scrolled ? 'shadow-lg shadow-forest-950/5' : ''">
